...
<body>
    <header style="height:150px;">
        <div>
            <div ><img style="width:15%;" src="./2560px-Google_Search_Console.svg.png" alt=""></div>
            <div style="display: flex; justify-content: start margin-top: 10px; border-bottom: 0.5px solid black">
            <h5 style="padding-right: 30px;">Introduzione</h5>
            <h5 style="padding-right: 30px;">Norme sulla privacy</h5>
            <h5 style="padding-right: 30px;">Termini di servizi</h5>
            <h5 style="padding-right: 30px;">Tecnologie</h5> 
            <h5 style="padding-right: 30px;">Domande frequenti</h5> 
            </div>
